...
data = dict(
    ...
    train=[dict(
        type=dataset_type,
        data_root=data_root,
        img_dir=f'train/segmentations/images',
        ann_dir=f'train/segmentations/labels',
        split=f'train/segmentations/splits/fold_{fold}.txt',
        img_suffix=".png",
        seg_map_suffix='.png',
        classes=classes,
        palette=palette,
    ...
    val=dict(
        ...
        img_dir=f'train/segmentations/images',
        ann_dir=f'train/segmentations/labels',
        split=f'train/segmentations/splits/fold_{holdout if holdout != -1 else 0}.txt',
        img_suffix=".png",
        seg_map_suffix='.png',
        classes=classes,
        palette=palette,
...
work_dir = f'./work_dirs/cow/convx_t_{nx}x_aug0_{"all" if holdout == -1 else ("f" + str(holdout))}'
